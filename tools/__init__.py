# This file is intended to contain comments only.
'''
/*
 ...
 */
'''
# In order to make Python treat a directory as container for modules,
# this file should exist. In its simplest form, and empty file following
# __init__.py filename is sufficient for this purpose.
